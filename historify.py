...
token = util.prompt_for_user_token(
        username="pramesh99",
        scope="user-top-read",
        client_id="8ca7b0fc46c54a0e895d9b1115fc9cfb",
        client_secret="080f0e59008c471a94c17619d25af8f9",
...
for sp_range in ranges:
    ...
    results = user = spotify.current_user_top_tracks(time_range = sp_range, limit = 10)
    for i, item in enumerate(results['items']):
        print("{}: {} by {}".format(i + 1, item["name"], item['artists'][0]['name']))
    print()
...
# Checks to see if token is valid and gets a new token if not valid
